...
const events = Object(_mock_event__WEBPACK_IMPORTED_MODULE_0__["generateEventList"])();
const tripPresenter = new _presenter_trip__WEBPACK_IMPORTED_MODULE_3__["default"](mainTripElement, tripControlsElement, tripEventsContainer, eventsModel, filterModel);
const filterPresenter = new _presenter_filter__WEBPACK_IMPORTED_MODULE_4__["default"](tripControlsElement, filterModel);

eventsModel.setEvents(events);
events.sort(_utils_sort__WEBPACK_IMPORTED_MODULE_7__["sortByDate"]);
...
/*!***************************!*\
  !*** ./src/mock/event.js ***!
  \***************************/
/*! exports provided: generateId, generateEventList */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _utils_event_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/event-types */ "./src/utils/event-types.js");
...
const generateEventType = () => {
  const randomIndex = getRandomInteger(0, _utils_event_types__WEBPACK_IMPORTED_MODULE_1__["EVENT_TYPES"].length - 1);

  return _utils_event_types__WEBPACK_IMPORTED_MODULE_1__["EVENT_TYPES"][randomIndex];
};
...
const generateEvent = () => {
  const startDate = dayjs__WEBPACK_IMPORTED_MODULE_0___default()().add(getRandomInteger(-7, 7), `day`).format();
  const endDate = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(startDate).add(getRandomInteger(1, 200), `hour`).format();
...
class Events extends _utils_observer__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._events = [];
  }
...
/* harmony import */ var _utils_observer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/observer */ "./src/utils/observer.js");
/* harmony import */ var _utils_filter_type__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/filter-type */ "./src/utils/filter-type.js");
...
class Filter extends _utils_observer__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._activeFilter = _utils_filter_type__WEBPACK_IMPORTED_MODULE_1__["FilterType"].EVERYTHING;
  }
...
/* harmony import */ var _utils_user_action__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/user-action */ "./src/utils/user-action.js");
/* harmony import */ var _utils_update_type__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/update-type */ "./src/utils/update-type.js");
...
class EventNew {
  ...
  init() {
    ...
    this._formEditComponent = new _view_event_form__WEBPACK_IMPORTED_MODULE_0__["default"]({}, true);
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(this._eventListContainer, this._formEditComponent, _utils_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].AFTERBEGIN);
  ...
  destroy() {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._formEditComponent);
    this._formEditComponent = null;
  ...
  _handleFormSubmit(event) {
    this._changeData(_utils_user_action__WEBPACK_IMPORTED_MODULE_3__["UserAction"].ADD_EVENT, _utils_update_type__WEBPACK_IMPORTED_MODULE_4__["UpdateType"].MINOR, Object.assign({id: Object(_mock_event__WEBPACK_IMPORTED_MODULE_1__["generateId"])()}, event));
    this.destroy();
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EventPresenter; });
...
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/render */ "./src/utils/render.js");
/* harmony import */ var _utils_button_codes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/button-codes */ "./src/utils/button-codes.js");
/* harmony import */ var _utils_user_action__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/user-action */ "./src/utils/user-action.js");
/* harmony import */ var _utils_update_type__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/update-type */ "./src/utils/update-type.js");
/* harmony import */ var _utils_date__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utils/date */ "./src/utils/date.js");
...
class EventPresenter {
  ...
  init(event) {
    ...
    this._event = event;
    this._eventComponent = new _view_event__WEBPACK_IMPORTED_MODULE_0__["default"](event);
    this._eventFormComponent = new _view_event_form__WEBPACK_IMPORTED_MODULE_1__["default"](event);
    ...
    if (prevEventComponent === null || prevFormComponent === null) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(this._eventListContainer, this._eventComponent);
      return;
    }

    if (this._mode === Mode.DEFAULT) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._eventListContainer, this._eventComponent, prevEventComponent);
    }

    if (this._mode === Mode.EDITING) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._eventListContainer, this._eventFormComponent, prevFormComponent);
    }

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(prevEventComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(prevFormComponent);
  }

  destroy() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._eventComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._eventFormComponent);
  }
  ...
  _replaceEventToForm() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._eventListContainer, this._eventFormComponent, this._eventComponent);
  ...
  _replaceFormToEvent() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._eventListContainer, this._eventComponent, this._eventFormComponent);
  ...
  _handleFormSubmit(newData) {
    const isMinorUpdate =
      !Object(_utils_date__WEBPACK_IMPORTED_MODULE_6__["isDatesEqual"])(this._event.startDate, newData.startDate) ||
      !Object(_utils_date__WEBPACK_IMPORTED_MODULE_6__["isDatesEqual"])(this._event.endDate, newData.endDate) ||
      this._event.price !== newData.price;

    this._replaceFormToEvent();

    this._changeData(_utils_user_action__WEBPACK_IMPORTED_MODULE_4__["UserAction"].UPDATE_EVENT, isMinorUpdate ? _utils_update_type__WEBPACK_IMPORTED_MODULE_5__["UpdateType"].MINOR : _utils_update_type__WEBPACK_IMPORTED_MODULE_5__["UpdateType"].PATCH, newData);
  }

  _handleDeleteClick(event) {
    this._changeData(_utils_user_action__WEBPACK_IMPORTED_MODULE_4__["UserAction"].DELETE_EVENT, _utils_update_type__WEBPACK_IMPORTED_MODULE_5__["UpdateType"].MINOR, event);
  }

  _onEscKeyDown(evt) {
    if (evt.key === _utils_button_codes__WEBPACK_IMPORTED_MODULE_3__["ESC_BUTTON_CODE"]) {
      evt.preventDefault();
      this._eventFormComponent.reset(this._event);
      this._replaceFormToEvent();
    }
  ...
  _handleFavoriteClick() {
    ...
    this._changeData(_utils_user_action__WEBPACK_IMPORTED_MODULE_4__["UserAction"].UPDATE_EVENT, _utils_update_type__WEBPACK_IMPORTED_MODULE_5__["UpdateType"].MINOR, newData);
  }
}
...
/* harmony import */ var _utils_filter_type__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/filter-type */ "./src/utils/filter-type.js");
/* harmony import */ var _utils_update_type__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/update-type */ "./src/utils/update-type.js");
...
class Filter {
  ...
  init() {
    ...
    if (prevFilterComponent === null) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filterContainer, this._filterComponent);
      return;
    }

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._filterContainer, this._filterComponent, prevFilterComponent);
  ...
  _handleFilterTypeChange(filterType) {
    ...
    this._filterModel.setFilter(_utils_update_type__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].MAJOR, filterType);
  }

  _getFilters() {
    return [
      {
        type: _utils_filter_type__WEBPACK_IMPORTED_MODULE_2__["FilterType"].EVERYTHING,
        name: `EVERYTHING`
      },
      {
        type: _utils_filter_type__WEBPACK_IMPORTED_MODULE_2__["FilterType"].PAST,
        name: `PAST`
      },
      {
        type: _utils_filter_type__WEBPACK_IMPORTED_MODULE_2__["FilterType"].FUTURE,
        name: `FUTURE`
      }
    ];
  }
...
/* harmony import */ var _view_list_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/list.js */ "./src/view/list.js");
/* harmony import */ var _view_list_empty__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../view/list-empty */ "./src/view/list-empty.js");
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utils/render */ "./src/utils/render.js");
/* harmony import */ var _event__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./event */ "./src/presenter/event.js");
/* harmony import */ var _event_new__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./event-new */ "./src/presenter/event-new.js");
/* harmony import */ var _utils_sort__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/sort */ "./src/utils/sort.js");
/* harmony import */ var _utils_sort_type__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utils/sort-type */ "./src/utils/sort-type.js");
/* harmony import */ var _utils_update_type__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../utils/update-type */ "./src/utils/update-type.js");
/* harmony import */ var _utils_user_action__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../utils/user-action */ "./src/utils/user-action.js");
/* harmony import */ var _utils_filter__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../utils/filter */ "./src/utils/filter.js");
/* harmony import */ var _utils_filter_type__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../utils/filter-type */ "./src/utils/filter-type.js");
...
class TripPresenter {
  constructor(mainTripContainer, tripControlsContainer, tripEventsContainer, eventsModel, filterModel) {
    ...
    this._currentSortType = _utils_sort_type__WEBPACK_IMPORTED_MODULE_10__["SortType"].DAY;

    this._tripSortComponent = null;

    this._tripInfoComponent = new _view_trip_info__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._tripPriceComponent = new _view_trip_price__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._siteMenuComponent = new _view_menu__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._eventListComponent = new _view_list_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._emptyListComponent = new _view_list_empty__WEBPACK_IMPORTED_MODULE_5__["default"]();
    ...
    this._eventNewPresenter = new _event_new__WEBPACK_IMPORTED_MODULE_8__["default"](this._eventListComponent, this._handleViewAction);
  }

  init() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_6__["render"])(this._mainTripContainer, this._tripInfoComponent, _utils_render__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].AFTERBEGIN);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_6__["render"])(this._tripInfoComponent.getElement(), this._tripPriceComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_6__["render"])(this._tripControlsContainer, this._siteMenuComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_6__["render"])(this._tripEventsContainer, this._eventListComponent);
  ...
  _renderSort() {
    ...
    this._tripSortComponent = new _view_trip_sort__WEBPACK_IMPORTED_MODULE_3__["default"](this._currentSortType);
    this._tripSortComponent.setSortTypeChangeHandler(this._handleSortTypeChange);

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_6__["render"])(this._tripEventsContainer, this._tripSortComponent, _utils_render__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].AFTERBEGIN);
  }

  _renderEvent(eventsListContainer, event) {
    const eventPresenter = new _event__WEBPACK_IMPORTED_MODULE_7__["default"](eventsListContainer, this._handleViewAction, this._handleModeChange);
  ...
  _renderNoEvents() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_6__["render"])(this._eventListComponent.getElement(), this._emptyListComponent, _utils_render__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].AFTERBEGIN);
  }
  ...
  _getEvents() {
    ...
    const filteredEvents = _utils_filter__WEBPACK_IMPORTED_MODULE_13__["filter"][filterType](events);

    switch (this._currentSortType) {
      case _utils_sort_type__WEBPACK_IMPORTED_MODULE_10__["SortType"].DAY:
        return filteredEvents.sort(_utils_sort__WEBPACK_IMPORTED_MODULE_9__["sortByDate"]);
      case _utils_sort_type__WEBPACK_IMPORTED_MODULE_10__["SortType"].PRICE:
        return filteredEvents.sort(_utils_sort__WEBPACK_IMPORTED_MODULE_9__["sortByPrice"]);
      case _utils_sort_type__WEBPACK_IMPORTED_MODULE_10__["SortType"].DURATION:
        return filteredEvents.sort(_utils_sort__WEBPACK_IMPORTED_MODULE_9__["sortByDuration"]);
    }
  ...
  _clearTripBoard({resetSortType = false} = {}) {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_6__["remove"])(this._tripSortComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_6__["remove"])(this._emptyListComponent);
  ...
  _handleViewAction(actionType, updateType, update) {
    switch (actionType) {
      case _utils_user_action__WEBPACK_IMPORTED_MODULE_12__["UserAction"].UPDATE_EVENT:
        this._eventsModel.updateEvent(updateType, update);
        break;
      case _utils_user_action__WEBPACK_IMPORTED_MODULE_12__["UserAction"].ADD_EVENT:
        this._eventsModel.addEvent(updateType, update);
        break;
      case _utils_user_action__WEBPACK_IMPORTED_MODULE_12__["UserAction"].DELETE_EVENT:
  ...
  _handleModelEvent(updateType, data) {
    switch (updateType) {
      case _utils_update_type__WEBPACK_IMPORTED_MODULE_11__["UpdateType"].PATCH:
        this._eventPresenter[data.id].init(data);
        break;
      case _utils_update_type__WEBPACK_IMPORTED_MODULE_11__["UpdateType"].MINOR:
        this._clearTripBoard();
        this._renderTripBoard();
        break;
      case _utils_update_type__WEBPACK_IMPORTED_MODULE_11__["UpdateType"].MAJOR:
  ...
  _handleSortTypeChange(sortType) {
    if (this._currentSortType === _utils_sort_type__WEBPACK_IMPORTED_MODULE_10__["SortType"]) {
      return;
    }
  ...
  createTask() {
    this._currentSortType = _utils_sort_type__WEBPACK_IMPORTED_MODULE_10__["SortType"].DEFAULT;
    this._filterModel.setFilter(_utils_update_type__WEBPACK_IMPORTED_MODULE_11__["UpdateType"].MAJOR, _utils_filter_type__WEBPACK_IMPORTED_MODULE_14__["FilterType"].EVERYTHING);
...
/***/ "./src/utils/button-codes.js":
/*!***********************************!*\
  !*** ./src/utils/button-codes.js ***!
  \***********************************/
/*! exports provided: ESC_BUTTON_CODE */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ESC_BUTTON_CODE", function() { return ESC_BUTTON_CODE; });
...
/*!***************************!*\
  !*** ./src/utils/date.js ***!
  \***************************/
/*! exports provided: formatDuration, getDuration, isDatesEqual */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const getDuration = (startDate, endDate) => dayjs__WEBPACK_IMPORTED_MODULE_0___default()(endDate).diff(startDate);

const isDatesEqual = (dateA, dateB) => {
  return (dateA === null && dateB === null) ? true : dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dateA).isSame(dateB);
};


/***/ }),

/***/ "./src/utils/event-types.js":
/*!**********************************!*\
  !*** ./src/utils/event-types.js ***!
  \**********************************/
...
const filter = {
  [_utils_filter_type__WEBPACK_IMPORTED_MODULE_1__["FilterType"].EVERYTHING]: (events) => events.filter((event) => event),
  [_utils_filter_type__WEBPACK_IMPORTED_MODULE_1__["FilterType"].PAST]: (events) => events.filter((event) => dayjs__WEBPACK_IMPORTED_MODULE_0___default()().isAfter(event.startDate)),
  [_utils_filter_type__WEBPACK_IMPORTED_MODULE_1__["FilterType"].FUTURE]: (events) => events.filter((event) => dayjs__WEBPACK_IMPORTED_MODULE_0___default()().isBefore(event.startDate))
};
...
class Observer {
  ...
  removeObserver(observer) {
    this._observers = this._observers.filter((existingObservers) => existingObservers !== observer);
  }
...
const replace = (container, newChild, oldChild) => {
...
/*!***************************!*\
  !*** ./src/utils/sort.js ***!
  \***************************/
/*! exports provided: sortByDate, sortByPrice, sortByDuration */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const sortByDate = (a, b) => {
  if (dayjs__WEBPACK_IMPORTED_MODULE_0___default()(a.startDate).isBefore(b.startDate)) {
    return -1;
  }

  if (dayjs__WEBPACK_IMPORTED_MODULE_0___default()(a.startDate).isAfter(b.startDate)) {
    return 1;
  }
...
const sortByDuration = (a, b) => {
  const durationA = Object(_utils_date__WEBPACK_IMPORTED_MODULE_1__["getDuration"])(a.startDate, a.endDate);

  const durationB = Object(_utils_date__WEBPACK_IMPORTED_MODULE_1__["getDuration"])(b.startDate, b.endDate);
...
/* harmony import */ var _utils_event_types__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/event-types */ "./src/utils/event-types.js");
...
const createEventFormTemplate = (event = {}) => {
  const {type = _utils_event_types__WEBPACK_IMPORTED_MODULE_3__["EVENT_TYPES"][0], destinationName = ``, price = ``, offers = [], destinationInfo} = event;
  ...
  const typesFragment = _utils_event_types__WEBPACK_IMPORTED_MODULE_3__["EVENT_TYPES"].map((eventType) => (`
...
class EventForm extends _smart__WEBPACK_IMPORTED_MODULE_4__["default"] {
  ...
  _formSubmitHandler(evt) {
    ...
    const startDate = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(startDateUnformatted, DAYJS_DATE_FORMAT).format();
    const endDateUnformatted = this.getElement().querySelector(`[name="event-end-time"]`).value;
    const endDate = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(endDateUnformatted, DAYJS_DATE_FORMAT).format();
  ...
  _setStartDatePicker() {
    ...
    const config = {
      ...
      defaultDate: dayjs__WEBPACK_IMPORTED_MODULE_0___default()(this._data.startDate).toDate(),
      defaultHour: dayjs__WEBPACK_IMPORTED_MODULE_0___default()(this._data.startDate).hour(),
      defaultMinute: dayjs__WEBPACK_IMPORTED_MODULE_0___default()(this._data.startDate).minute(),
      enableTime: true,
      time_24hr: true, // eslint-disable-line camelcase
      maxDate: dayjs__WEBPACK_IMPORTED_MODULE_0___default()(this._data.endDate).toDate(),
      onChange: this._startDateChangeHandler
    };

    this._startDatePicker = Object(flatpickr__WEBPACK_IMPORTED_MODULE_1__["default"])(this.getElement().querySelector(`[name="event-start-time"]`), config);
  }

  _startDateChangeHandler(selectedDates, startDate) {
    this._endDatePicker.set(`minDate`, startDate);
    this.updateData({
      startDate: dayjs__WEBPACK_IMPORTED_MODULE_0___default()(startDate, DAYJS_DATE_FORMAT).format()
    });
  }
  ...
  _setEndDatePicker() {
    ...
    const config = {
      dateFormat: `d/m/y H:i`,
      defaultDate: dayjs__WEBPACK_IMPORTED_MODULE_0___default()(this._data.endDate).toDate(),
      defaultHour: dayjs__WEBPACK_IMPORTED_MODULE_0___default()(this._data.endDate).hour(),
      defaultMinute: dayjs__WEBPACK_IMPORTED_MODULE_0___default()(this._data.endDate).minute(),
      enableTime: true,
      time_24hr: true, // eslint-disable-line camelcase
      minDate: dayjs__WEBPACK_IMPORTED_MODULE_0___default()(this._data.startDate).toDate(),
      onChange: this._endDateChangeHandler
    };

    this._endDatePicker = Object(flatpickr__WEBPACK_IMPORTED_MODULE_1__["default"])(this.getElement().querySelector(`[name="event-end-time"]`), config);
  }

  _endDateChangeHandler(selectedDates, endDate) {
    this._startDatePicker.set(`maxDate`, endDate);
    this.updateData({
      endDate: dayjs__WEBPACK_IMPORTED_MODULE_0___default()(endDate, DAYJS_DATE_FORMAT).format()
    });
  }
...
/* harmony import */ var _abstract__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./abstract */ "./src/view/abstract.js");
...
const createEventTemplate = (event) => {
  ...
  const startDateFullFormatted = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(startDate).format(`YYYY-MM-DD`);
  const startDateShortFormatted = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(startDate).format(`MMM D`);
  const startTime = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(startDate).format(TIME_FORMAT);
  const endTime = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(endDate).format(TIME_FORMAT);

  const duration = Object(_utils_date__WEBPACK_IMPORTED_MODULE_2__["getDuration"])(startDate, endDate);
  ...
  return (
    `<li class="trip-events__item">
      <div class="event">
        ...
        <h3 class="event__title">${type} ${he__WEBPACK_IMPORTED_MODULE_1___default.a.encode(destinationName)}</h3>
        <div class="event__schedule">
          ...
          <p class="event__duration">${Object(_utils_date__WEBPACK_IMPORTED_MODULE_2__["formatDuration"])(duration)}</p>
        </div>
...
class Event extends _abstract__WEBPACK_IMPORTED_MODULE_3__["default"] {
  constructor(event) {
    super();
...
class TripFilters extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripPrice; });
/* harmony import */ var _abstract__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract */ "./src/view/abstract.js");
...
class TripPrice extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/* harmony import */ var _utils_sort_type__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/sort-type */ "./src/utils/sort-type.js");
  ...
  return (
    `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
      <div class="trip-sort__item  trip-sort__item--day">
        <input id="sort-day" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-day" ${currentSortType === _utils_sort_type__WEBPACK_IMPORTED_MODULE_0__["SortType"].DAY ? `checked` : ``}>
        <label class="trip-sort__btn" for="sort-day" data-sort-type="${_utils_sort_type__WEBPACK_IMPORTED_MODULE_0__["SortType"].DAY}">Day</label>
      </div>
      ...
      <div class="trip-sort__item  trip-sort__item--time">
        <input id="sort-time" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-time" ${currentSortType === _utils_sort_type__WEBPACK_IMPORTED_MODULE_0__["SortType"].DURATION ? `checked` : ``}>
        <label class="trip-sort__btn" for="sort-time" data-sort-type="${_utils_sort_type__WEBPACK_IMPORTED_MODULE_0__["SortType"].DURATION}">Time</label>
      </div>

      <div class="trip-sort__item  trip-sort__item--price">
        <input id="sort-price" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-price" ${currentSortType === _utils_sort_type__WEBPACK_IMPORTED_MODULE_0__["SortType"].PRICE ? `checked` : ``}>
        <label class="trip-sort__btn" for="sort-price" data-sort-type="${_utils_sort_type__WEBPACK_IMPORTED_MODULE_0__["SortType"].PRICE}">Price</label>
      </div>
...
class TripSort extends _abstract__WEBPACK_IMPORTED_MODULE_1__["default"] {
